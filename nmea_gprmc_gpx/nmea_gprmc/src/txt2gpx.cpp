...
*/
	...
	// formated xml by https://github.com/xiaolaba
    char* gpx_xml[4] = {"<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n",	//gpx[0]
                        "<gpx\n"
						"  xmlns=\"http://www.topografix.com/GPX/1/1\"\n"
						"  version=\"1.1\"\n"
						"  creator=\"https://github.com/hongwenjun\">\n"
						"  <name>",															//gpx[1]
                        "</name>\n"
						"\t<trk> <name></name>\n"
						"\t\t<trkseg>\n",									//gpx[2]
    ...
    // 写 GPX XXML 文件头
    fprintf(outfile, "%s%s%s%s", gpx_xml[0], gpx_xml[1], "https://github.com/hongwenjun, formated xml by https://github.com/xiaolaba", gpx_xml[2]) ;
