...
// in Window dos box, change code page to utf-8 first, otherwise the following display in mess
// xiaolaba, 2022-NOV-26
// "chcp 65001"

void help()
{
    printf("\n\n本工具从NMEA文件里读取GPRMC的GPS时间戳(自动转换成gpx)  BY Hong Wenjun  2016.12.11\n\n");
